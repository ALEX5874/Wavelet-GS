...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.drifts_lr_init = 0.0
        self.drifts_lr_final = 0.0
        self.drifts_lr_delay_mult = 0.01
        self.drifts_lr_max_steps = self.iterations
        ...
        self.del_opacity_lr_init = 0.002
        self.del_opacity_lr_final = 0.00002
        self.del_opacity_lr_delay_mult = 0.01
        self.del_opacity_lr_max_steps = 40_000

        self.del_cov_lr_init = 0.004
        self.del_cov_lr_final = 0.004
        self.del_cov_lr_delay_mult = 0.01
        self.del_cov_lr_max_steps = 40_000

        self.del_color_lr_init = 0.008
        self.del_color_lr_final = 0.00005
        self.del_color_lr_delay_mult = 0.01
        self.del_color_lr_max_steps = 40_000

        self.res_opacity_lr_init = 0.002
        self.res_opacity_lr_final = 0.00002
        self.res_opacity_lr_delay_mult = 0.01
        self.res_opacity_lr_max_steps = 40_000

        self.res_cov_lr_init = 0.004
        self.res_cov_lr_final = 0.004
        self.res_cov_lr_delay_mult = 0.01
        self.res_cov_lr_max_steps = 40_000

        self.res_color_lr_init = 0.008
        self.res_color_lr_final = 0.00005
        self.res_color_lr_delay_mult = 0.01
        self.res_color_lr_max_steps = 40_000

        self.aggregate_lr_init = 0.008
        self.aggregate_lr_final = 0.00005
        self.aggregate_lr_delay_mult = 0.01
        self.aggregate_lr_max_steps = 40_000

        self.albedo_lr_init = 0.005
        self.albedo_lr_final = 0.001
        self.albedo_lr_delay_mult = 0.01
        self.albedo_lr_max_steps = 40_000

        self.albedo_mlp_lr_init = 0.008
        self.albedo_mlp_lr_final = 0.00005
        self.albedo_mlp_lr_delay_mult = 0.01
        self.albedo_mlp_lr_max_steps = 40_000

        self.lumi_sh_lr_init = 0.008
        self.lumi_sh_lr_final = 0.00005
        self.lumi_sh_lr_delay_mult = 0.01
        self.lumi_sh_lr_max_steps = 40_000

        self.env_sh_lr_init = 0.008
        self.env_sh_lr_final = 0.00005
        self.env_sh_lr_delay_mult = 0.01
        self.env_sh_lr_max_steps = 40_000
        ...
        self.wavelet_weight = 5.0
        self.wavelet_loss_checkpoint1 = 10000
        self.wavelet_loss_checkpoint2 = 15000
        self.wavelet_loss_scale1 = 0.5
        self.wavelet_loss_scale2 = 1.0
        self.wavelet_loss_scale3 = 1.5

        self.single_view_weight_from_iter = 10
        self.single_view_weight = 0.015
        self.scale_loss_weight = 10.0

        self.start_shadowed = 10000
        self.warmup = 10000
        ...
        self.ncc_weight = 0.05
        self.ncc_from_iter = 15000

        self.unshadowed_image_loss_lambda = 0.5
        self.shadowed_image_loss_lambda = 0.5

        # self.unshadowed_image_loss_lambda = 3.0
        # self.shadowed_image_loss_lambda = 3.0
...
def update_lambdas(iteration, opt):
    ...
    if iteration < opt.warmup:
        shadowed_image_loss_lambda = 0.01
    ...
    # For small number of iterations, tune only SH_gauss
        ...
        unshadowed_image_loss_lambda = 0.01
        # unshadowed_image_loss_lambda = 0.0
